...
<body>
	<div align="left">
		<form:form
			action="/spring-hibernate-e-application-single-table/backToStaffPortal"
			method="GET">
				...
				<tbody>
					<c:forEach var="information" items="${information }">
						<tr>
							...
							<td><a href="approveTransferStaff/${information.uniqueid}"><span
									class="glyphicon glyphicon-thumbs-up"></span></a></td>
							<td><a href="rejectTransferStaff?uniqueid=${information.uniqueid}"><span
